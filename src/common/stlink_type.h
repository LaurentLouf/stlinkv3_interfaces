...
// bool; In C++, the type bool is built in (although it is a 1-byte type in C++ mode, rather than a
// 4-byte type like in C mode). BOOL defined in windef.h
#endif
...
#define LONG \
    int  // int for signed 32 bits; Note that "long" is signed 32 bits on Windows, signed 64 bits on
         // Linux/MacOS => dangerous
#define LPSTR char *
